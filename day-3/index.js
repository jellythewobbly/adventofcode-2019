...
const part1 = Math.min(...Object.keys(both).map(point => point.split(',').reduce((acc, cur) => acc + Math.abs(+cur), 0)));
console.log(`Part 1: ${part1}`);
const part2 = Math.min(...Object.keys(both).map(point => points1[point] + points2[point]));
